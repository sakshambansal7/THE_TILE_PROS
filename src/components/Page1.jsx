  ...
  return (
    <>
      ...
      <div className='portfolio flex  justify-between mt-20 p-10' >
        ...
        <img className=' w-[36vw] z-30' src="https://images.squarespace-cdn.com/content/v1/5ef3f3458040a83686b6c004/b5f5e5c2-5b2e-4d51-95bf-b0ce3973208b/Aintree_bakery_27.jpg?format=2500w" alt="img" />
        <div className=' w-1/2'>

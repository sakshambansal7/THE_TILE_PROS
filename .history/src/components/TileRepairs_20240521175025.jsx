...
const TileRepairs = () => {
  return (
    ...
    <img class='w-[40vw]' src="..\public\images\cracked-floor-tile-2.jpeg" alt='Tile Repairing Image' />
    <div class='w-[50vw]'>
...
<div class="flex mx-auto p-8">
    <div class="flex-1 mr-8 h-full">
        ...
        <div className="flex gap-10 ">
            <img className='h-[40vh] w-[50vh]' src="..\public\images\Screenshot 2024-04-10 234141.png" alt="Image 1" /> 
            <img className='h-[40vh] w-[50vh]' src="..\public\images\Screenshot 2024-04-10 234300.png" alt="Image 2" />
        </div>
    </div>

    <div class="flex-1 fit">
        <img className='h-[108vh] w-[100vh]' src="..\public\images\Screenshot 2024-04-10 234141.png" alt="Big Image" />
    </div>
</div>

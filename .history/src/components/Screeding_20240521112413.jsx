...
const Screeding = () => {
  return (
    ...
    <img class='w-[40vw]' src="..\public\images\Screenshot 2024-04-10 234314.png" alt='Screeding Image' />
    <div class='w-[50vw]'>
...
<div class="flex mx-auto p-8">
    ...
    <div class="flex-1 fit">
        <img className='h-[108vh] w-[100vh]' src="..\public\images\screeding_concrete.webp" alt="Big Image" />
    </div>
</div>
